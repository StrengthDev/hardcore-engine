//! This module describes various kinds of *IO* related events.

use crate::io::input::Modifiers;
use hardcore_sys::{ButtonAction, KeyboardKey, MouseButton};
use std::path::PathBuf;

/// A window event.
///
/// This type of event should always be associated with a specific [`Window`][crate::io::window::Window].
#[derive(Debug, Clone)]
