...
namespace ENGINE_NAMESPACE {
    ...
    public:
        ...
        device(device &&other) noexcept:
                ...
                graphics_idx(std::exchange(other.graphics_idx, 0)),
                graphics_queue(std::exchange(other.graphics_queue, VK_NULL_HANDLE)),
                present_idx(std::exchange(other.present_idx, 0)),
                present_queue(std::exchange(other.present_queue, VK_NULL_HANDLE)),
                compute_idx(std::exchange(other.compute_idx, 0)),
                compute_queue(std::exchange(other.compute_queue, VK_NULL_HANDLE)),
                transfer_idx(std::exchange(other.transfer_idx, 0)),
                transfer_queue(std::exchange(other.transfer_queue, VK_NULL_HANDLE)),
