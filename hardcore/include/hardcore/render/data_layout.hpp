            ...
            for (u8 i = 0; i < layout.n_values; i++) {
                ...
                switch (layout[i].t) {
                    case data_layout::type::MAT2:
                        iterations = 2;
                        converted_type = data_layout::type::VEC2;
                        break;
                    case data_layout::type::MAT2x3:
                        iterations = 2;
                        converted_type = data_layout::type::VEC3;
                        break;
                    case data_layout::type::MAT2x4:
                        iterations = 2;
                        converted_type = data_layout::type::VEC4;
                        break;
    ...
    protected:
        struct value {
            ...
            [[nodiscard]] inline std::string to_string() const {
                ...
                switch (t) {
                    case ENGINE_NAMESPACE::data_layout::type::SCALAR:
                        not_scalar = false;
                        break;
                    case ENGINE_NAMESPACE::data_layout::type::VEC2:
                        stream << "vec2";
                        break;
                    case ENGINE_NAMESPACE::data_layout::type::VEC3:
                        stream << "vec3";
                        break;
                    case ENGINE_NAMESPACE::data_layout::type::VEC4:
                        stream << "vec4";
                        break;
                    case ENGINE_NAMESPACE::data_layout::type::MAT2:
                        stream << "mat2";
                        break;
                    case ENGINE_NAMESPACE::data_layout::type::MAT3:
                        stream << "mat3";
                        break;
                    case ENGINE_NAMESPACE::data_layout::type::MAT4:
                        stream << "mat4";
                        break;
                    case ENGINE_NAMESPACE::data_layout::type::MAT2x3:
                        stream << "mat2x3";
                        break;
                    case ENGINE_NAMESPACE::data_layout::type::MAT2x4:
                        stream << "mat2x4";
                        break;
                    case ENGINE_NAMESPACE::data_layout::type::MAT3x2:
                        stream << "mat3x2";
                        break;
                    case ENGINE_NAMESPACE::data_layout::type::MAT3x4:
                        stream << "mat3x4";
                        break;
                    case ENGINE_NAMESPACE::data_layout::type::MAT4x2:
                        stream << "mat4x2";
                        break;
                    case ENGINE_NAMESPACE::data_layout::type::MAT4x3:
                        stream << "mat4x3";
                        break;
                    default:
                    INTERNAL_ASSERT(false, "Unimplemented type");
                        break;
                }
                if (not_scalar) stream << '<';
                switch (ct) {
                    case ENGINE_NAMESPACE::data_layout::component_type::FLOAT32:
                        stream << "f32";
                        break;
                    case ENGINE_NAMESPACE::data_layout::component_type::FLOAT64:
                        stream << "f64";
                        break;
                    case ENGINE_NAMESPACE::data_layout::component_type::FLOAT16:
                        stream << "f16";
                        break;
                    case ENGINE_NAMESPACE::data_layout::component_type::INT8:
                        stream << "i8";
                        break;
                    case ENGINE_NAMESPACE::data_layout::component_type::INT16:
                        stream << "i16";
                        break;
                    case ENGINE_NAMESPACE::data_layout::component_type::INT32:
                        stream << "i32";
                        break;
                    case ENGINE_NAMESPACE::data_layout::component_type::INT64:
                        stream << "i64";
                        break;
                    case ENGINE_NAMESPACE::data_layout::component_type::UINT8:
                        stream << "u8";
                        break;
                    case ENGINE_NAMESPACE::data_layout::component_type::UINT16:
                        stream << "u16";
                        break;
                    case ENGINE_NAMESPACE::data_layout::component_type::UINT32:
                        stream << "u32";
                        break;
                    case ENGINE_NAMESPACE::data_layout::component_type::UINT64:
                        stream << "u64";
                        break;
                    default:
                    INTERNAL_ASSERT(false, "Unimplemented component type");
                        break;
                }
                if (not_scalar) stream << '>';
                return stream.str();
