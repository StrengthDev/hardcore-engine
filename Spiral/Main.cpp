	...
	*/
	...
	void createLogicalDevice() {
		...
		for (uint32_t queueFamily : uniqueQueueFamilies) {
			...
			queueCreateInfo.pQueuePriorities = &queuePriority;	//idk why priority is missing
		...
		createInfo.pQueueCreateInfos = queueCreateInfos.data();	//if theres only 1 queue set as &queueCreateInfo
	...
	VkPresentModeKHR chooseSwapPresentMode(const std::vector<VkPresentModeKHR>& availablePresentModes) {	//Vsync, look into this later
	...
	VkExtent2D chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) {	//resolution, look into this later
	...
	void createSwapChain() {
		...
		createInfo.preTransform = swapChainSupport.capabilities.currentTransform; //image tranforms such as rotations or flipping, current means no tranforms applied
