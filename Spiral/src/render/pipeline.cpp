...
namespace ENGINE_NAMESPACE
{
	...
	{
		spiral::graphics_pipeline& pipeline = *reinterpret_cast<spiral::graphics_pipeline*>(pipeline_p);
...
#undef SET_DESCRIPTOR
	...
	{
		spiral::graphics_pipeline& pipeline = renderer::get_device().get_graphics_pipeline(id);
