...
namespace hc::render::device {
	...
	*/
	struct Resource {
		...
		VkDeviceSize frame_pad;
		//!< The value used to calculate the offset to the currently active area of this resource's buffer.
		VkDeviceSize offset;

		//!< The offset to this resource within its buffer's currently active area. (Includes alignment padding)
		struct Logistics {
