...
namespace hc::render::device {
    ...
    private:
        ...
        struct CreationParams {
            ...
            u32 image_count = 0;
            VkSurfaceTransformFlagBitsKHR transform = VkSurfaceTransformFlagBitsKHR::VK_SURFACE_TRANSFORM_FLAG_BITS_MAX_ENUM_KHR;
        } creation_params;
        ...
        std::queue<InnerSwapchain> old_swapchains; //!< A queue containing old inner swapchains, in order of deprecation.
    };
}
